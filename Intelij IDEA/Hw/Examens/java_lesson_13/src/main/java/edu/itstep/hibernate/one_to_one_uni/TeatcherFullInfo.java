...
@Entity
@Table(name = "teatchers_full_info")
public class UserFullInfo {
    ...
    public UserFullInfo(String email, String country, String city, String address, boolean isMarried, String dateOfBirth, int countChildren) {
        this.email = email;
