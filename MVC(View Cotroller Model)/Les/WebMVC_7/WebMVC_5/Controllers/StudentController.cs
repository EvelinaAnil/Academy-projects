...
namespace WebMVC_5.Controllers
{
    public class StudentController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,LastName,FirstName,BirthDate,Email,Grant,PhotoFile")] Student student)
        {
        ...
        public async Task<ActionResult> Edit([Bind(Include 
            = "Id,LastName,FirstName,BirthDate,Email,Grant,PhotoFile")] Student student)
        {
            if (ModelState.IsValid)
            {
